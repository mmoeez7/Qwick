...
export default function WashingtonDCPage() {
    return (
        <div className="relative h-auto">
            ...
            {/* Service Area Header */}
            <ServicesHeader title="Commercial Kitchen Exhaust Cleaning in Washington, DC" />
            ...
            <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    >
                        Qwick Services and Solutions LLC helps Washington, DC restaurants and commercial kitchens keep their exhaust systems, hoods, ducts, and fire suppression equipment clean and code-compliant. Our trained technicians work around your schedule to minimize downtime while meeting NFPA standards.
                    </p>
                </div>
            </section>
