        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between overflow-hidden rounded-2xl sm:rounded-3xl bg-[#C1FF72] p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 min-h-[400px] md:min-h-[500px]">
          ...
          <div className="relative z-10 max-w-3xl md:max-w-4xl lg:max-w-5xl w-full md:w-auto mb-6 md:mb-0">
            ...
            <div className="relative mb-4 sm:mb-6">
              ...
              <h2 className="text-[24px] sm:text-[24px] md:text-[28px] lg:text-[28px] xl:text-[28px] font-bold text-black relative z-10 pr-4 md:pr-8 lg:pr-16 tracking-tight">
              If you are looking for a long‑term partner to handle kitchen exhaust cleaning, hood and duct service, fire suppression inspections, or preventive maintenance, Qwick Services and Solutions LLC is ready to help
              </h2>
            </div>
