        ...
        <section className="py-6 sm:py-8 md:py-10 lg:py-12 bg-[#F9F9F9]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="relative flex flex-col md:flex-row md:items-center md:justify-between overflow-hidden rounded-2xl sm:rounded-3xl bg-[#C1FF72] p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 min-h-[400px] md:min-h-[500px]">
                    ...
                    {/* ================= LEFT CONTENT ================= */}
                    <div className="relative z-10 max-w-3xl md:max-w-4xl lg:max-w-5xl w-full md:w-auto mb-6 md:mb-0">
                        {/* Quotes + Heading */}
                        <div className="relative mb-4 sm:mb-6">
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-black relative z-10 pr-4 md:pr-8 lg:pr-16">
                        ...
                        <div className="max-w-2xl">
                            <p className="mb-6 sm:mb-8 md:mb-10 text-sm sm:text-base md:text-lg lg:text-lg leading-relaxed text-black tracking-tight font-bold">
                                For routine quote requests submitted through this page, a member of our team typically
                                responds within one business day. For urgent issues, please call 202-643-8113 so the team
                                can prioritize your request
                            </p>
                            <p className="mb-6 sm:mb-8 md:mb-10 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-black tracking-tight font-bold">If you are experiencing a shutdown, failed inspection, or post‑incident cleanup need, call
                                202-643-8113 instead of using the form so a technician can be dispatched as quickly as
                                possible.
                            </p>
                        </div>
