...
export default function Footer() {
  ...
  const socialIcons = [
    { name: "facebook", src: "/footer/icon facebook.svg" },
    { name: "youtube", src: "/footer/icon youtube.svg" },
    { name: "instagram", src: "/footer/icon instagram.svg" },
    { name: "linkedin", src: "/footer/icon linkedin.svg" }
  ];
