  ...
  return (
    <div className="relative z-10 flex flex-col items-start mt-16 sm:mt-20 justify-center h-[80dvh] px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-12 sm:pb-16">
      ...
      <div 
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/hero/HeroBg.svg')",
        }}
      />
      ...
      <div className="container mx-auto max-w-5xl relative z-10 w-full">
        ...
        <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6">
          <button className="bg-transparent border-2 border-[#C1FF72] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-4xl font-semibold text-base sm:text-lg hover:bg-[#C1FF72] hover:text-black transition-colors relative z-10">
            Request a Survey 
          </button>
        </div>
