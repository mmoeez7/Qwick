...
export default function ServicesSection() {
  const services = [
    {
      icon: "/Home/serviceSection/icon1.svg", // First icon
    ...
    {
      icon: "/Home/serviceSection/icon2.svg", // Lightning bolt
    ...
    {
      icon: "/Home/serviceSection/icon3.svg", // Filter/document icon
    ...
    {
      icon: "/Home/serviceSection/icon4.svg", // Speech bubble
