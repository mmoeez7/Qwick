        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between overflow-hidden rounded-2xl sm:rounded-3xl bg-[#C1FF72] p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 min-h-[400px] md:min-h-[500px]">
          ...
          <div className="relative z-10 max-w-2xl w-full md:w-auto mb-6 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6">
              <button className="rounded-lg sm:rounded-xl bg-black px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg font-semibold text-white transition hover:opacity-90 w-full sm:w-auto">
                Request a Quote
              </button>

              <button className="rounded-lg sm:rounded-xl border-2 border-black px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg font-semibold text-black transition hover:bg-white/20 w-full sm:w-auto">
                Call Us
              </button>
            </div>
          </div>
