  ...
  const services = [
    {
      ...
      title: "24/7 response for shutdowns, failed inspections, and urgent issues",
    },
    {
        icon: "/Home/ChooseUs/sheild.svg",
        title: "Focus on immediate safety and compliance so you can reopen faster",
      },
      {
        icon: "/Home/ChooseUs/repair.svg",
        title: "Clear documentation for inspectors, landlords, and insurers",
      }
  ];
