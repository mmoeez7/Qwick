  ...
  const services = [
    {
      ...
      title: "Complete hood, duct, and fan cleaning for NFPA 96 compliance",
    },
    {
        icon: "/Home/ChooseUs/sheild.svg",
        title: "Safe, food‑service–appropriate degreasers and high‑pressure rinsing",
      },
      {
        icon: "/Home/ChooseUs/timer.svg",
        title: "Scheduled maintenance plans to reduce surprise shutdowns and citations",
      }
  ];
