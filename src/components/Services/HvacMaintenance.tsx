  ...
  const services = [
    {
      ...
      title: "Inspection and service of rooftop and make‑up air units.",
    },
    {
        icon: "/Home/ChooseUs/flash.svg",
        title: "Airflow balancing to reduce negative pressure and drafts",
      },
      {
        icon: "/Home/ChooseUs/repair.svg",
        title: "Comfort‑focused adjustments that support staff and guests",
      }
  ];
